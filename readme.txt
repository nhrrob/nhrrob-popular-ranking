...
## Configuration
### Plugin Settings
There are no settings. Just browse the Poplar Plugins menu in the dashboard.

### Customization
There is a search bar to provide username. You can provide any username to see the plugins of that author.
...
No. It works as a standalone. And it is very lite.

= Can I see all my plugins at a glance? =
...
= Shows blank page or no plugins =

When you have plugins which are not listed in the popular plugins ranking provided by WordPress then those plugins won't appear in the table.
